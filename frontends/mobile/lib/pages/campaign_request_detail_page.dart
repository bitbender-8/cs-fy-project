...
class _CampaignRequestDetailPageState extends State<CampaignRequestDetailPage> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                _campaignRequest!
                                    .title, // This will update after successful edit
                              ...
                              Row(
                                children: [
                                  Text(
                                    'Type: ${(_campaignRequest?.requestType.value)}',
                                    style: currentTheme.textTheme.bodyLarge,
                                  ),
                                  const Spacer(),
                                  Text(
                                    'Status: ${_campaignRequest!.resolutionType}',
                                    style: currentTheme.textTheme.bodyLarge
                                        ?.copyWith(
                                      color: _campaignRequest!.resolutionType ==
                                              ResolutionType.accepted
                                          ? Colors.green
                                          : _campaignRequest!.resolutionType ==
                              ...
                              Text(
                                _campaignRequest!
                                    .justification, // This will update
                                style: currentTheme.textTheme.bodyMedium,
      ...
      setState(() {
        if (result.data != null) {
          ...
          _errorMessage = result.error?.toString() ??
              'Failed to load campaign request details.';
        }
        _isLoading = false;
      });
    }
  ...
  //     if (accessToken == null) {
  //       showErrorSnackBar(
  //           context, 'You are not logged in. Please log in again.');
  //       setState(() => _isLoading = false);
  //       return;
  //     }
  ...
  //           SnackBar(
  //               content: Text(
  //                   result.error?.toString() ?? 'Failed to update request.')),
  //         );
  //       }
  //     }
  //   }
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      onPressed:
                          _isUpdating ? null : null, // _handleUpdateRequest,
                      child: _isUpdating
                          ? const SizedBox(
                              height: 20,
                              width: 20,
